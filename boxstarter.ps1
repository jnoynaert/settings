...
# if using a whitelist approach, for removing apps:
#Get-AppxPackage -AllUsers | where-object {$_.name -Match "store|calculator|appinstaller|edge|onenote|whiteboard|paint"} | ForEach-Object Remove-AppxPackage $_
...
Set-TaskbarOptions -Dock Bottom -Combine Always -Lock
...
#TODO: move this to Linux when WSL2 releases
...
#Ubuntu1804 run apt-get install build-essential
